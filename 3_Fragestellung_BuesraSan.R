## Q8_2 Arbeitsplätze knapp -> Haben Männer mehr Recht auf Arbeit?
# 1 - Einverstanden
# 2 - Weder Noch
...
## Was ist in der Variablen q55 drin? ##
tally(ds$q55)
...
## Ueberpruefung der Altersklassenbildung ##
a <- data.frame(Alter=ds$Alter, Altersklasse=ds$Altersklasse)
library(plyr)
